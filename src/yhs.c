...
static int accept_request(yhsServer *server,SOCKET *accepted_sock,char *my_addr)
{
	...
	*accepted_sock=accept(server->listen_sock,(struct sockaddr *)&client_addr,&client_addr_size);
	...
	strcpy(my_addr, client_addr_str);
...
static int accept_new_connections(yhsServer *server)
{
	...
	for(;;)
	{
		...
		if(!accept_request(server,&re.sock,&re.ip))
			break;
...
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
YHS_EXTERN char* yhs_get_ip(yhsRequest *re) {
	return re->ip;
}
